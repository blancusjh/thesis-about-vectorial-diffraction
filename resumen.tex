...
iluminación azimutalmente simétrica. A diferencia de los formalismos
comúnmente empleados en difracción vectorial, este tratamiento incorpora
punto a punto la transformación vectorial inducida por la superficie
refractora, determinada conjuntamente por su geometría y por los
coeficientes locales de Fresnel. Se evidenció así la existencia de
...
transforms under azimuthally symmetric illumination. Unlike commonly used
vector diffraction formalisms, this treatment incorporates at each point the
vector transformation induced by the refracting surface, determined jointly
by its geometry and the local Fresnel coefficients. This evidences the
existence of aberrations of purely vectorial origin in stigmatic systems:
